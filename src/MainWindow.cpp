  ...
  _device_model(this)
{
  ...
  setWindowIcon(QIcon(QIcon(":/resources/usbguard-icon.svg").pixmap(64)));
...
{
  systray = new QSystemTrayIcon(QIcon(QIcon(":/resources/usbguard-icon-inactive.svg").pixmap(64)), this);
  ...
  const usbguard::Rule& device_rule)
{
  ...
  QSystemTrayIcon::MessageIcon notification_icon = QSystemTrayIcon::Information;
...
void MainWindow::stopFlashing()
{
  ...
  if (IPCClient::isConnected()) {
    systray->setIcon(QIcon(QIcon(":/resources/usbguard-icon.svg").pixmap(64)));
  }
  else {
    systray->setIcon(QIcon(QIcon(":/resources/usbguard-icon-inactive.svg").pixmap(64)));
  }
}
...
{
  if (_flash_state) {
    systray->setIcon(QIcon(QIcon(":/resources/usbguard-icon-warning.svg").pixmap(64)));
    systray->show();
